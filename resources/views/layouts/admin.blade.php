...
<head>
    ...
    <link rel="apple-touch-icon" href="{{asset('storage/assets/admin/images/ico/apple-icon-120.png')}}">
    <link rel="shortcut icon" type="image/x-icon" href="{{asset('storage/assets/admin/images/ico/favicon.ico')}}">
    <link
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('storage/assets/admin/css-rtl/core/menu/menu-types/vertical-menu.css')}}">
    ...
    <link rel="stylesheet" type="text/css"
          href="{{asset('storage/assets/admin/css-rtl/core/menu/menu-types/vertical-menu.css')}}">
